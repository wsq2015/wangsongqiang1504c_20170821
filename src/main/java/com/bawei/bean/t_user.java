...
public class t_user implements Serializable {
    /*
    a)	创建名为***_test的数据库（***：为自己姓名的拼音全拼），建用户表t_user(编号ID,姓名name,用户名username,密码password),
     建商品表t_goods(编号ID,商品名称goodsname,商品价格price,商品数量account),建订单表t_order(编号ID,用户编号user_id,商品编号goods_id,商品数量goods_account)
